# 킹받아서 직접 만든 2024 메이플스토리 뉴네임 옥션 사이트
...
## 왜 만들었나?
- 메이플스토리는 대부분 유저들이 2글자 닉네임을 선호하는데, 한 글자만 입력해도 검색어가 나올 수 있도록 만들었습니다.
- 닉네임 검색을 할때, 검색버튼을 눌러야 나오는 결과가 UX측면에서 떨어진다 생각하여 개선해 보았습니다.
- 검색을 하고 다시 전체목록을 클릭해서 리스트를 보여주는 것이 UI/UX가 떨어진다고 생각하여, 사용자가 닉네임 검색란을 공백으로 비웠을 때, 자동으로 다시 전체 리스트가 나올 수 있도록 만들었습니다.
